        ...
        <div class="col-md-12">
           ...
           <table class="table table-bordered">
            <thead>
                ...
                <th class="product-thumbnail">QR Code</th>
            ...
            <tbody>
                @foreach($order as $o)
                @php
                $total = $o->subtotal + $o->biaya_cod;
                @endphp
                <tr>
                    <td>{{ $o->invoice }}</td>
                    <td>{!! QrCode::generate('https://api.whatsapp.com/send?phone=62895343286759&text=Saya%20ingin%20melakukan%20konfirmasi%20pesanan%20dengan%20%0AID-INVOICE%20%3A%20'.$o->invoice.'%20%0AJumlah%20%3A%20Rp.%20'.$total.'%0Abiayar%20Jumlah%20sudah%20termasuk%20biaya%20ongkir%2C%20terimakasih%20sudah%20menghubungi%20kami%0A'); !!}</td>

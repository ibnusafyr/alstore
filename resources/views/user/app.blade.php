...
<html lang="en">
  <head>
    <title>Alas Lokal Store &mdash; Toko  Online Zaman Now</title>
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="{{ asset('adminassets') }}/assets/images/als.png" />
  </head>
  <body>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
              <form action="{{ route('user.produk.cari') }}" method="get" class="site-block-top-search" >
                ...
                <input type="text" class="form-control border-0" name="cari" placeholder="Search" autocomplete="off">
              </form>
            </div>

            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="{{ url('/') }}" class="js-logo-clone">Alas Lokal Store</a>
              </div>
            </div>
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="{{ route('logout') }}"
                                  ...
                                  <i class="mdi mdi-logout mr-0 text-primary"></i>Logout 
                              </a>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-6">
            ...
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">{{ $alamat->prov }},{{ $alamat->kota }},{{ $alamat->detail }}</li>
                <li class="phone"><a href="tel://23923929210">+62859141490060</a></li>
                <li class="email">info@als.com</li>
              </ul>
            </div>
            @endif
